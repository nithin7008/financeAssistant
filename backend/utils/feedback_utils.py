...
def save_feedback_to_json(feedback_entry: dict):
    ...
    try:
        ...
        logger.error(f"Failed to save feedback to JSON: {e}")
...
def load_feedback_to_chromadb(client, embedding_fn):
    ...
    try:
        ...
        try:
            ...
            logger.info("Using existing user_feedback collection")
        except:
            ...
            logger.info("Created new user_feedback collection")
        ...
        logger.info(f"Loaded {len(feedback_list)} feedback entries into ChromaDB.")
    except Exception as e:
        logger.error(f"Failed to load feedback into ChromaDB: {e}")
